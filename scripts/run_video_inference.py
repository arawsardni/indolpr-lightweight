...
if __name__ == "__main__":
    ...
    default_yolo = os.path.join(project_root, "results/detection/yolo11_lpr/baseline_run7/weights/best.pt")
    default_lpr = os.path.join(project_root, "models", "lprnet_best.pth")
